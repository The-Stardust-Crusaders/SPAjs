        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileIconEncodedString = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendRelations_AspNetUsers_InitiatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    LandsatName = table.Column<string>(nullable: true),
                    CloudCover = table.Column<float>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CmapType = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Maps_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reposts_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reposts_AspNetUsers_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Maps_RequestId",
                table: "Maps",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Reposts_RequestId",
                table: "Reposts",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Reposts_UserProfileId",
                table: "Reposts",
